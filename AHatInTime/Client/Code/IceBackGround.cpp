...
CIceBackGround::CIceBackGround(LPDIRECT3DDEVICE9 pGraphicDev)
	: CGameObject(pGraphicDev)
{

}

CIceBackGround::CIceBackGround(const CIceBackGround& rhs)
	: CGameObject(rhs)
{

}

CIceBackGround::~CIceBackGround(void)
{

}

HRESULT CIceBackGround::Ready_Object(void)
{
...
Engine::_int CIceBackGround::Update_Object(const _float& fTimeDelta)
{
...
void CIceBackGround::Render_Object(void)
{
...
HRESULT CIceBackGround::Add_Component(void)
{
...
HRESULT CIceBackGround::SetUp_Material(void)
{
	D3DMATERIAL9		tMtrl;
...
CIceBackGround* CIceBackGround::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CIceBackGround*	pInstance = new CIceBackGround(pGraphicDev);
...
void CIceBackGround::Set_TextureComponent(const _tchar * pTextureProtoTag)
{
	CComponent*			pComponent = nullptr;
