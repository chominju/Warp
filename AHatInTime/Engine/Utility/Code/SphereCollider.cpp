...
CSphereCollider* Engine::CSphereCollider::Create(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3* pPos, const _ulong& dwNumVtx, const _ulong& dwVtxSize)
{
...
HRESULT Engine::CSphereCollider::Ready_Collider(const _vec3* pPos, const _ulong& dwNumVtx, const _ulong& dwVtxSize)
{
...
void Engine::CSphereCollider::Render_Collider(COLLTYPE eType, const _matrix* pColliderMatrix)
{
